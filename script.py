...
# Default: delete 5 comments/likes at once. You can change this if you want to delete more at once.
AT_ONCE_DELETE = 5
    ...
    while True:
        ...
        while selected_count == 0:
            ...
            if while_it_count > 5:
                ...
                time.sleep(random.uniform(CHECK_EVERY * 0.9, CHECK_EVERY * 1.9))
