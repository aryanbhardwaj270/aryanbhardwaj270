 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "    \"name\" : ['vaibhav', 'aryan', 'aditya', 'itish', 'pari'],\n",
    "    \"balance\" : [10000, 12000, 7000, 9000, 10000],\n",
    "    \"password\" : ['admin', 'pass', 'passwd', '1234567', 'papakipari'],\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "                    #withdraw part\n",
    "                    elif i4 == 2 :\n",
    "                        print(\"withdraw\".center(90))\n",
    "                        print(\".\"*100)\n",
    "                        print(f\"your balance -->  {data['balance'][check]}\")\n",
    "                        i5 = int(input(\"enter withdraw amount : \"))\n",
    "                        if 0 < i5 <= data['balance'][check]:\n",
    "                            withdraw = data['balance'][check]-i5\n",
    "                            data['balance'][check] = withdraw\n",
    "                            print(f\"your remaining balance -->  {data['balance'][check]}\")\n",
    "                        else:\n",
    "                            print(\"your withdraw amount is more than balance \")\n",
    "                        continue\n",
    "                        \n",
    "                        \n",
    "                    #credit part\n",
    ...
    "        acc = 1002 + len(data['accno'])\n",
    "        data['accno'].append(acc)\n",
    "        acc = 1003 + len(data['accno'])\n",
    "        data['accno'].append(acc)\n",
    "        acc = 1004 + len(data['accno'])\n",
    "        data['accno'].append(acc)\n",
    "        acc = 1005 + len(data['accno'])\n",
    "        data['accno'].append(acc)\n",
